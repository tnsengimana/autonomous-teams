...
export default async function AideAgentDetailPage({
  ...
  // Get agent and verify it belongs to the aide
    ...
    <div className="flex flex-col space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/aides/${aide.id}/agents/${agent.id}/edit`}>
            <Button variant="outline" size="sm" className="gap-2">
              <Edit className="h-4 w-4" />
              Edit
            </Button>
          </Link>
          <Link href={`/aides/${aide.id}/agents/${agent.id}/inspect`}>
            <Button variant="outline" size="sm" className="gap-2">
              <Eye className="h-4 w-4" />
              Inspect
            </Button>
          </Link>
          <Link href={`/aides/${aide.id}/agents/${agent.id}/chat`}>

...
/**
 * GET /api/entities/[id]/agents/[agentId] - Get a specific agent
 */
export async function GET(
  ...
  try {
    ...
    const { id: entityId, agentId } = await params;
    ...
    if (agent.entityId !== entityId) {
      return NextResponse.json(
        { error: "Agent does not belong to this entity" },
        { status: 403 }
      );
    }
...
/**
 * PATCH /api/entities/[id]/agents/[agentId] - Update an agent
 */

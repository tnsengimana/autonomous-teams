...
/**
 * GET /api/teams/[id]/agents/[agentId] - Get a specific agent
 */
export async function GET(
  ...
  try {
    ...
    const { id: teamId, agentId } = await params;
    ...
    if (agent.teamId !== teamId) {
      return NextResponse.json({ error: 'Agent does not belong to this team' }, { status: 403 });
    }
...
/**
 * PATCH /api/teams/[id]/agents/[agentId] - Update an agent
 */
